disease_dic = {
    ...
    'Apple___Black_rot': """ <b>Crop</b>: Apple <br/>Disease: Black Rot<br/>
        ...
        <br/>4. Be sure to remove the stumps of any apple trees you cut down. Dead stumps can be a source of spores.""",
    ...
    'Apple___healthy': """ <h2><b>Crop</b>: Apple <br/>Disease: No disease<br/> </h2>
    ...
    'Tomato___healthy': """ <h2><b>Crop</b>: Tomato <br/>Disease: No disease<br/></h2>
    ...
    'Potato___Late_blight': """<h2> <b>Crop</b>: Potato <br/>Disease: Late Blight<br/></h2>
